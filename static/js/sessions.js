...
function _deselectCurrentSession(sid) {
  ...
  uiModule.el('current-meta').textContent = 'J.A.R.V.I.S Chat';
...
export async function selectSession(id, { keepSidebar = false } = {}) {
  ...
  try {
    ...
    // URL hash — the user complained that coming back to J.A.R.V.I.S kept
    ...
    if (currentMetaEl) {
      currentMetaEl.textContent = meta ? meta.name : 'J.A.R.V.I.S Chat';
    }
