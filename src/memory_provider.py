...
class MemoryProvider(ABC):
    """Base contract for J.A.R.V.I.S memory providers.
...
class NativeMemoryProvider(MemoryProvider):
    """Provider adapter for J.A.R.V.I.S' built-in memory manager and vector store."""

    provider_id = "native"
    display_name = "J.A.R.V.I.S native memory"
