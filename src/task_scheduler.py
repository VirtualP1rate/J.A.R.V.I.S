...
class TaskScheduler:
    ...
    async def _deliver_via_email(self, output: str, task, result: str):
        ...
        try:
            ...
            msg["X-J.A.R.V.I.S-Origin"] = "jarvis-ui"
            msg["X-J.A.R.V.I.S-Kind"] = "task"
            msg["X-J.A.R.V.I.S-Ref"] = str(task.id)
    ...
    async def _deliver_via_mcp(self, tool_name: str, task, result: str):
        ...
        args = {
            ...
            "body": result,
            "headers": {
                "X-J.A.R.V.I.S-Origin": "jarvis-ui",
                "X-J.A.R.V.I.S-Kind": "task",
                "X-J.A.R.V.I.S-Ref": str(task.id),
            },
        }
        if recipient:
