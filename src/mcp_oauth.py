...
Registration, authorization-code + PKCE, token refresh) to J.A.R.V.I.S's web
...
# on J.A.R.V.I.S. APP_PORT is intentionally not used: it is only the Docker host
