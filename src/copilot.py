...
COPILOT_USER_AGENT = os.environ.get(
    "JARVIS_COPILOT_USER_AGENT", "J.A.R.V.I.S/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "JARVIS_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "JARVIS_COPILOT_EDITOR_VERSION", "J.A.R.V.I.S/1.0"
)
