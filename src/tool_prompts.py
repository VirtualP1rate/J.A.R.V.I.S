...
Per-tool usage docs injected into the agent system prompt. Extracted from
agent_loop.py to slim that module; still re-exported there so existing
importers (routes.skills_routes, src.tool_policy, tests) keep working.
"""
