...
# TOOL_SECTIONS now lives in src/tool_prompts.py; re-exported here for callers
# that import it from agent_loop (skills_routes, tool_policy, tests).
from src.tool_prompts import TOOL_SECTIONS  # noqa: E402
