                        ...
                        if jm:
                            ...
                            if urgency in ("critical", "high"):
                                try:
                                    ...
                                    # Deep-link to open the original email in J.A.R.V.I.S (if public URL is configured).
                                    ...
                                    alert_body = (
                                        ...
                                        f"Reason: {reason}\n\n"
                                        + (f"Open in J.A.R.V.I.S: {open_url}\n\n" if open_url else "")
                                        + f"---\n"
                                        f"From: {sender}\n"
                                        f"Subject: {subject}\n"
                                        f"Date: {msg.get('Date','')}\n\n"
                                    ...
                                    # HTML alternative with a clickable "Open in J.A.R.V.I.S" button
                                    import html as _h
    ...
    try:
        ...
        for r in rows:
            ...
            try:
                ...
                outer["X-J.A.R.V.I.S-Origin"] = "jarvis-ui"
                outer["X-J.A.R.V.I.S-Kind"] = re.sub(r"[^A-Za-z0-9_.-]", "-", jarvis_kind or "scheduled")[:64]
                outer["X-J.A.R.V.I.S-Ref"] = sid
                if r[6]:
