...
J.A.R.V.I.S stands on the shoulders of a lot of open-source work. This file
...
- **[Tongyi DeepResearch](https://github.com/Alibaba-NLP/DeepResearch)** by
  **Alibaba-NLP / Tongyi Lab** — the multi-step deep-research agent pipeline.
  Copyright © Alibaba-NLP / Tongyi Lab. **Apache-2.0.** Adapted for J.A.R.V.I.S's
...
and run alongside J.A.R.V.I.S on `docker compose up`. They are not modified —
just composed.
...
J.A.R.V.I.S talks to these over the network/API. They are **not** distributed
...
- **`caldav`** (Python lib) is **dual-licensed GPL-3.0-or-later OR Apache-2.0**.
  J.A.R.V.I.S uses it under **Apache-2.0**, which is permissive and MIT-compatible.
...
Most of J.A.R.V.I.S's code was written *with* AI models, not just by a human.
