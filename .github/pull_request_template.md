...
- [ ] I searched [open issues](https://github.com/pewdiepie-archdaemon/jarvis/issues) and [open PRs](https://github.com/pewdiepie-archdaemon/jarvis/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses J.A.R.V.I.S's existing visual language. Specifically:
